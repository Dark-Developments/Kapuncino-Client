...
import coffee.client.feature.gui.screen.AltManagerScreen;
...
public abstract class ClientLoginNetworkHandlerMixin {
    ...
    private @Nullable Text joinServerSession(String serverId) {
        try {
            if (AltManagerScreen.EasyMCToken != null){
                joinServer(AltManagerScreen.EasyMCToken, client.getSession().getUuidOrNull(), serverId);
            }
