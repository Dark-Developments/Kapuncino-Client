...
public class Bookban extends Command {
    ...
    private void writeBook(PrimitiveIterator.OfInt chars) {
        ...
        String title = "§5§lThe Holy Bible";

        // Write data to book
        client.player.getMainHandStack().setSubNbt("title", NbtString.of(title));
        ...
        client.player.networkHandler.sendPacket(new BookUpdateC2SPacket(client.player.getInventory().selectedSlot, pages, Optional.of(title)));
    }
}
